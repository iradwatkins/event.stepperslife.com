...
class Inflectible
{
    ...
    {
        yield new Transformation(new Pattern('/ú([sn])$/i'), 'Barn2\Plugin\WC_Product_Options\Dependencies\u\1es');
        yield new Transformation(new Pattern('/ó([sn])$/i'), 'Barn2\Plugin\WC_Product_Options\Dependencies\o\1es');
        yield new Transformation(new Pattern('/í([sn])$/i'), 'Barn2\Plugin\WC_Product_Options\Dependencies\i\1es');
        yield new Transformation(new Pattern('/é([sn])$/i'), 'Barn2\Plugin\WC_Product_Options\Dependencies\e\1es');
        yield new Transformation(new Pattern('/á([sn])$/i'), 'Barn2\Plugin\WC_Product_Options\Dependencies\a\1es');
