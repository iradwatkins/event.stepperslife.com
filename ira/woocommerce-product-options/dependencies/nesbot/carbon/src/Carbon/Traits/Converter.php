...
use Barn2\Plugin\WC_Product_Options\Dependencies\Carbon\CarbonPeriodImmutable;
use Barn2\Plugin\WC_Product_Options\Dependencies\Carbon\Exceptions\UnitException;
use Closure;
use DateTime;
...
trait Converter
{
    ...
    public function __toString()
    {
        ...
        return $format instanceof Closure ? $format($this) : $this->rawFormat($format ?: (\defined('Barn2\Plugin\WC_Product_Options\Dependencies\static::DEFAULT_TO_STRING_FORMAT') ? static::DEFAULT_TO_STRING_FORMAT : CarbonInterface::DEFAULT_TO_STRING_FORMAT));
    }
    /**
    ...
    {
        return $this->avoidMutation()->setTimezone('GMT')->rawFormat(\defined('Barn2\Plugin\WC_Product_Options\Dependencies\static::RFC7231_FORMAT') ? static::RFC7231_FORMAT : CarbonInterface::RFC7231_FORMAT);
    }
    /**
