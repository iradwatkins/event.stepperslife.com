 ...
 */
namespace Barn2\Plugin\WC_Product_Options\Dependencies\Carbon\Traits;

use Barn2\Plugin\WC_Product_Options\Dependencies\Carbon\CarbonInterface;
use Barn2\Plugin\WC_Product_Options\Dependencies\Carbon\Exceptions\InvalidTypeException;
use Barn2\Plugin\WC_Product_Options\Dependencies\Carbon\Exceptions\NotLocaleAwareException;
use Barn2\Plugin\WC_Product_Options\Dependencies\Carbon\Language;
use Barn2\Plugin\WC_Product_Options\Dependencies\Carbon\Translator;
use Barn2\Plugin\WC_Product_Options\Dependencies\Carbon\TranslatorStrongTypeInterface;
use Closure;
use Barn2\Plugin\WC_Product_Options\Dependencies\Symfony\Component\Translation\TranslatorBagInterface;
use Barn2\Plugin\WC_Product_Options\Dependencies\Symfony\Component\Translation\TranslatorInterface;
use Barn2\Plugin\WC_Product_Options\Dependencies\Symfony\Contracts\Translation\LocaleAwareInterface;
use Barn2\Plugin\WC_Product_Options\Dependencies\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (interface_exists('Barn2\Plugin\WC_Product_Options\Dependencies\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('Barn2\Plugin\WC_Product_Options\Dependencies\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('Barn2\Plugin\WC_Product_Options\Dependencies\Symfony\Contracts\Translation\TranslatorInterface', 'Barn2\Plugin\WC_Product_Options\Dependencies\Symfony\Component\Translation\TranslatorInterface');
}
