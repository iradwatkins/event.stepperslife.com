...
if (!\function_exists('Barn2\Plugin\WC_Product_Options\Dependencies\array_last')) {
    ...
    function array_last($array, ?callable $callback = null, $default = null)
    {
        ...
        return Arr::first(\array_reverse($array, \true), $callback, $default);
    }
}
...
if (!\function_exists('str_contains') && !\function_exists('Barn2\Plugin\WC_Product_Options\Dependencies\str_contains')) {
    /**
