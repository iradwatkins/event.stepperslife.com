...
if (!\function_exists('edd_hidden_callback') && !\function_exists('Barn2\Plugin\WC_Product_Options\Dependencies\edd_hidden_callback')) {
...
if (!\function_exists('edd_barn2_license_callback') && !\function_exists('Barn2\Plugin\WC_Product_Options\Dependencies\edd_barn2_license_callback')) {
