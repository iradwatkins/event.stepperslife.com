...
use ArrayIterator;
use Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Contracts\Support\ValidatedData;
use stdClass;
class ValidatedInput implements ValidatedData
{
    ...
    public function only($keys)
    {
        ...
        foreach (is_array($keys) ? $keys : func_get_args() as $key) {
            $value = \Barn2\Plugin\WC_Product_Options\Helpers::data_get($input, $key, $placeholder);
