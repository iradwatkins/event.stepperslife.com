...
use Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Http\Client\Factory;
/**
 ...
 * @method static \Illuminate\Http\Client\Response \Barn2\Plugin\WC_Product_Options\Helpers::head(string $url, array|string|null $query = null)
