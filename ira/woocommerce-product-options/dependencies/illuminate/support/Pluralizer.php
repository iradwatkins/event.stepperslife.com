...
use Barn2\Plugin\WC_Product_Options\Dependencies\Doctrine\Inflector\Inflector;
use Barn2\Plugin\WC_Product_Options\Dependencies\Doctrine\Inflector\InflectorFactory;
class Pluralizer
{
    /**
