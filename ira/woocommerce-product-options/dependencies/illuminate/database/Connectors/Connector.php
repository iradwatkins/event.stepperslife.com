...
use Barn2\Plugin\WC_Product_Options\Dependencies\Doctrine\DBAL\Driver\PDOConnection;
use Exception;
use Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Database\DetectsLostConnections;
use PDO;
use Throwable;
class Connector
{
