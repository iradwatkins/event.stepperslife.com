...
use Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Support\ConfigurationUrlParser;
...
class DatabaseManager implements ConnectionResolverInterface
{
    ...
    {
        if (!class_exists('Barn2\Plugin\WC_Product_Options\Dependencies\Doctrine\DBAL\Connection')) {
    ...
    public function usingConnection($name, callable $callback)
    {
        ...
        return \Barn2\Plugin\WC_Product_Options\Helpers::tap($callback(), function () use ($previousName) {
