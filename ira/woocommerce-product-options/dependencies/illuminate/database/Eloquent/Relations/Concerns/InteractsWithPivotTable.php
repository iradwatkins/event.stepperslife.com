...
namespace Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Database\Eloquent\Relations\Concerns;
...
trait InteractsWithPivotTable
{
    ...
    {
        return $this->sync(\Barn2\Plugin\WC_Product_Options\Helpers::collect($this->parseIds($ids))->mapWithKeys(function ($id) use ($values) {
            return [$id => $values];
        }), $detaching);
    }
    /**
    ...
    {
        return \Barn2\Plugin\WC_Product_Options\Helpers::collect($records)->mapWithKeys(function ($attributes, $id) {
