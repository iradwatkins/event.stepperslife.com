...
namespace Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Database\Schema\Grammars;

use Barn2\Plugin\WC_Product_Options\Dependencies\Doctrine\DBAL\Schema\AbstractSchemaManager as SchemaManager;
use Barn2\Plugin\WC_Product_Options\Dependencies\Doctrine\DBAL\Schema\TableDiff;
use Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Database\Connection;
use Barn2\Plugin\WC_Product_Options\Dependencies\Illuminate\Database\Grammar as BaseGrammar;
...
abstract class Grammar extends BaseGrammar
{
    ...
    public function getDoctrineTableDiff(Blueprint $blueprint, SchemaManager $schema)
    {
        ...
        return \Barn2\Plugin\WC_Product_Options\Helpers::tap(new TableDiff($table), function ($tableDiff) use ($schema, $table) {
