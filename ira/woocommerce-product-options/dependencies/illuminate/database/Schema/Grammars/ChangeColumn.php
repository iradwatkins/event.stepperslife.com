...
use Barn2\Plugin\WC_Product_Options\Dependencies\Doctrine\DBAL\Schema\Comparator;
use Barn2\Plugin\WC_Product_Options\Dependencies\Doctrine\DBAL\Schema\Table;
