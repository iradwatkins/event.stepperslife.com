...
use Barn2\Plugin\WC_Product_Options\Dependencies\Doctrine\DBAL\Schema\Index;
...
class SQLiteGrammar extends Grammar
{
    ...
    protected function addForeignKeys(Blueprint $blueprint)
    {
        ...
        return \Barn2\Plugin\WC_Product_Options\Helpers::collect($foreigns)->reduce(function ($sql, $foreign) {
    ...
    public function compileAdd(Blueprint $blueprint, Fluent $command)
    {
        ...
        return \Barn2\Plugin\WC_Product_Options\Helpers::collect($columns)->reject(function ($column) {
